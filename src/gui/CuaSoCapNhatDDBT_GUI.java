...
public class CuaSoCapNhatDDBT_GUI extends JDialog {
	...
	private JTextField txtTongCocThem;
	private double tongTienCoc1 = 0.0; // Biến toàn cục để lưu tổng tiền cọc
	private double tienConLai;
	

    public CuaSoCapNhatDDBT_GUI(DatBanTruoc_GUI01 ddbtFrame,LocalDateTime thoiGianNhanBan, Double tongTienCoc, Ban banTamTinh, KhachHang khTamTinh,NhanVien nvien,String maDDBT , int soLuongKH, String GhiChu , JTable tblFormMonAn) {
    
    	super((Frame) null, "Thông tin cập nhật đơn đặt bàn trước", true);
        setFont(new Font("Arial", Font.BOLD, 20));
        setDefaultCloseOperation(JDialog.DISPOSE_ON_CLOSE);
        Dimension screenSize = Toolkit.getDefaultToolkit().getScreenSize();
        setSize(screenSize);
        setLocationRelativeTo(null); 
        this.ddbtFrame = ddbtFrame; HoaDon hdcapnhat = hoaDon_dao.getHoaDonTheoMaDonDatBanTruoc(maDDBT);
        DonDatBanTruoc doncapnhat = DDBT_dao.getDonDatBanTheoMa(maDDBT);
        String maHD = hdcapnhat.getMaHD();
        String maDon = doncapnhat.getMaDonDatBanTruoc();
        ...
        panelThongTinDon.setBorder(BorderFactory.createTitledBorder(
                BorderFactory.createLineBorder(new Color(30, 129, 191)),
                "Thông tin đơn",
                TitledBorder.LEFT, TitledBorder.TOP,
                titleFont, new Color(30, 129, 191)
        ));
        panelThongTinDon.setBorder(new CompoundBorder(
                panelThongTinDon.getBorder(),
                new EmptyBorder(15, 15, 15, 15)
        ));

        txtMaHoaDon = new JTextField(); txtMaHoaDon.setEditable(false);
        txtMaDonDatBan = new JTextField(); txtMaDonDatBan.setEditable(false);
        txtMaBan = new JTextField(); txtMaBan.setEditable(false);
        txtThoiGianNhan = new JTextField(); txtThoiGianNhan.setEditable(false);
        ...
        panelThongTinMon.setBorder(BorderFactory.createTitledBorder(
                BorderFactory.createLineBorder(new Color(30, 129, 191)),
                "Thông tin món",
                TitledBorder.LEFT, TitledBorder.TOP,
                titleFont, new Color(30, 129, 191)
        ));
        panelThongTinMon.setBorder(new CompoundBorder(
                panelThongTinMon.getBorder(),
                new EmptyBorder(15, 15, 15, 15)
        ));
        DefaultTableModel modelThongTinMon = new DefaultTableModel(
                new Object[][]{},
        ...
        panelThongTinKH.setBorder(new CompoundBorder(
                panelThongTinKH.getBorder(),
                new EmptyBorder(15, 15, 15, 15)
        ));

        txtSoDienThoai = new JTextField(); txtSoDienThoai.setEditable(false);
        txtTenKhachHang = new JTextField(); txtTenKhachHang.setEditable(false);
        ...
        panelThongTinKH.setMaximumSize(new Dimension(Integer.MAX_VALUE, 200));
        panelRight.add(panelThongTinKH);
        panelRight.add(Box.createVerticalStrut(20));

        // Thông tin cọc
        JPanel panelThongTinCoc = new JPanel(new GridLayout(4, 2, 15, 15));
        panelThongTinCoc.setBorder(BorderFactory.createTitledBorder(
                BorderFactory.createLineBorder(new Color(30, 129, 191)),
                "Thông tin cọc",
                TitledBorder.LEFT, TitledBorder.TOP,
                titleFont, new Color(30, 129, 191)
        ));
        panelThongTinCoc.setBorder(new CompoundBorder(
                panelThongTinCoc.getBorder(),
                new EmptyBorder(15, 15, 15, 15)
        ));

        txtCocBan = new JTextField(); txtCocBan.setEditable(false);
        txtCocMon = new JTextField(); txtCocMon.setEditable(false);
        txtTongCoc = new JTextField(); txtTongCoc.setEditable(false);
        txtTongCocThem = new JTextField(); txtTongCocThem.setEditable(false);
        ...
        panelThongTinCoc.add(new JLabel("Tổng thêm (nếu có):"));
        panelThongTinCoc.add(txtTongCocThem);
     ...
     // Khối ghi chú
        ...
        panelGhiChu.setBorder(BorderFactory.createTitledBorder(
                BorderFactory.createLineBorder(new Color(30, 129, 191)),
                "Ghi chú",
                TitledBorder.LEFT, TitledBorder.TOP,
                titleFont, new Color(30, 129, 191)
        ));
        panelGhiChu.setBorder(new CompoundBorder(
                panelGhiChu.getBorder(),
                new EmptyBorder(15, 15, 15, 15)
        ));

        
        
        JTextArea GHiChuHD = new JTextArea(5, 20); // 5 dòng, 20 cột
        ...
        txtTongCocThem.setCaretColor(new Color(0, 0, 0, 0));
     ...
     tienConLai = tongTienCoc - doncapnhat.getTienCoc();
     
     if (tienConLai <= 1) {
         txtTongCocThem.setText("0 VNĐ");
         tongTienCoc1 = doncapnhat.getTienCoc();
     } else {
         txtTongCocThem.setText(String.format("%,.0f VNĐ", tienConLai));
         tongTienCoc1= tongTienCoc ;
     }

     System.out.println("Tiền cọc: " + doncapnhat.getTienCoc() );
     System.out.println("Tổng tiền cọc: " + tienConLai);
        ...
        btn1.setBackground(new Color(220, 53, 69));   
        btn1.setForeground(Color.WHITE);

        btn2.setBackground(new Color(255, 193, 7));  
        btn2.setForeground(Color.BLACK);

        btn3.setBackground(new Color(40, 167, 69)); 
        btn3.setForeground(Color.WHITE);  
        btn1.addActionListener(e -> {
        	int confirm = JOptionPane.showConfirmDialog(null, "Bạn có chắc muốn làm mới hủy bỏ các thông tin đã điền ?", "Xác nhận làm mới",
        ...
        btn3.addActionListener(e -> {
        	xuLyXacNhan(maDDBT, soLuongKH, thoiGianNhanBan, tongTienCoc1, khTamTinh, nvien, banTamTinh, GHiChuHD.getText(), tblFormMonAn, maHD,maDon);
        });
    ...
    public void xuLyXacNhan(String maDDBT, int soLuongKH, LocalDateTime thoiGianNhanBan,
                        double tongTienCoc, KhachHang khTamTinh, NhanVien nvien, Ban banTamTinh,
                        String GhiChu, JTable tblFormMonAn, String maHD, String maDon) {

    LocalDateTime thoiGianTao = LocalDateTime.now();

            DonDatBanTruoc DDBT_CapNhat = new DonDatBanTruoc(maDDBT, thoiGianTao,
                    soLuongKH, thoiGianNhanBan, tongTienCoc, khTamTinh, nvien, banTamTinh, 0);
            boolean capNhat = DDBT_dao.updateDonDatBanTruoc(DDBT_CapNhat);
            HoaDon hdCapNhat = hoaDon_dao.getHoaDonTheoMaDonDatBanTruoc(maDDBT);

            HoaDon hd = new HoaDon(hdCapNhat.getMaHD(), banTamTinh, DDBT_CapNhat, khTamTinh,
                    nvien, thoiGianTao, 2, soLuongKH, GhiChu);

            boolean capNhatHD = hoaDon_dao.updateHoaDon(hd);
            boolean xoaCTHD = ctHD_dao.xoaChiTietHoaDonTheoMaHD(hdCapNhat.getMaHD());
            DefaultTableModel model_luu = (DefaultTableModel) tblFormMonAn.getModel();
            capNhatChiTietHD(model_luu, hdCapNhat);
            if (capNhat && capNhatHD && xoaCTHD) {
            	String htmlContent = generateHtmlEmailContent(khTamTinh.getSdtKH(), maDon, maHD);

    			sendEmail(khTamTinh.getEmailKH(), "THÔNG TIN CẬP NHẬT ĐẶT BÀN TẠI NHÀ HÀNG KAREM", htmlContent);
    			dispose();
    			ddbtFrame.getBtnLamMoi().doClick();
			} else {
...
//		HoaDon hd = hoaDon_dao.timHoaDonTheoMaHoaDon(maHD);
		...
		LocalDateTime thoiGianNhanBan = ddbt.getThoiGianNhanBan(); 
		...
		html.append("<html><body style='font-family:Arial,sans-serif;'>").append("<p>Kính gửi Quý khách <strong>")
				...
				.append("<p>Chúng tôi trân trọng thông báo rằng Quý khách đã cập nhật đặt bàn thành công tại nhà hàng <strong>KAREM</strong>.</p>")
				...
				.append(ddbt.getBan().getMaBan()).append("</li>").append("<li><strong>Tiền cọc thêm:</strong> ")
				.append(String.format("%,.0f VND",tienConLai)).append("</li>").append("</li>").append("</ul>")
